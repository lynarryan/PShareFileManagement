...
/*HEADER:
*  PSHARE_FILEMANAGER_EVENT_SEND
*
*  DESCRIPTION:
*	Some event is being sent from the filemanager to the filemangers of
*	the siblings on the network
*
* PAYLOAD:
*	n bytes: event comprised of data to be written to the directory 
*	used in p-share on the siblings side
*/
#define PSHARE_FILEMANAGER_EVENT_SEND 0x06
